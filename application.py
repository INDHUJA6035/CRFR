...
def crop_rec():
    data1 = float(request.form['cra'])
    data2 =float(request.form['crb'])
    data3 = float(request.form['crc'])
    data4 = float(request.form['crd'])
    data5 = float(request.form['cre'])
    data6 = float(request.form['crf'])
    data7 = float(request.form['crg'])
